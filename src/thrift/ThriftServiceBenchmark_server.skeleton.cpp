...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<ThriftServiceBenchmarkHandler> handler(new ThriftServiceBenchmarkHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new ThriftServiceBenchmarkProcessor(handler));
