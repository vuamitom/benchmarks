...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > ThriftServiceBenchmarkProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ThriftServiceBenchmarkIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< ThriftServiceBenchmarkIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new ThriftServiceBenchmarkProcessor(handler));
  return processor;
}
